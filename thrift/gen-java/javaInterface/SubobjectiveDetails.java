            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attr_names = new java.util.ArrayList<java.lang.String>(_list54.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attr_values = new java.util.ArrayList<java.util.List<java.lang.String>>(_list57.size);
                java.util.List<java.lang.String> _elem58;
                for (int _i59 = 0; _i59 < _list57.size; ++_i59)
                {
                  {
                    org.apache.thrift.protocol.TList _list60 = iprot.readListBegin();
                    _elem58 = new java.util.ArrayList<java.lang.String>(_list60.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.scores = new java.util.ArrayList<java.lang.Double>(_list63.size);
                double _elem64;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.taken_by = new java.util.ArrayList<java.lang.String>(_list66.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.justifications = new java.util.ArrayList<java.util.List<java.lang.String>>(_list69.size);
                java.util.List<java.lang.String> _elem70;
                for (int _i71 = 0; _i71 < _list69.size; ++_i71)
                {
                  {
                    org.apache.thrift.protocol.TList _list72 = iprot.readListBegin();
                    _elem70 = new java.util.ArrayList<java.lang.String>(_list72.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SubobjectiveDetails struct) throws org.apache.thrift.TException {
      ...
      if (struct.attr_names != null) {
        oprot.writeFieldBegin(ATTR_NAMES_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter75 : struct.attr_names)
          {
      ...
      if (struct.attr_values != null) {
        oprot.writeFieldBegin(ATTR_VALUES_FIELD_DESC);
        {
          ...
          for (java.util.List<java.lang.String> _iter76 : struct.attr_values)
          {
            {
      ...
      if (struct.taken_by != null) {
        oprot.writeFieldBegin(TAKEN_BY_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter79 : struct.taken_by)
          {
      ...
      if (struct.justifications != null) {
        oprot.writeFieldBegin(JUSTIFICATIONS_FIELD_DESC);
        {
          ...
          for (java.util.List<java.lang.String> _iter80 : struct.justifications)
          {
            {
      ...
      if (struct.isSetAttr_names()) {
        {
          ...
          for (java.lang.String _iter82 : struct.attr_names)
          {
      ...
      if (struct.isSetAttr_values()) {
        {
          ...
          for (java.util.List<java.lang.String> _iter83 : struct.attr_values)
          {
            {
              oprot.writeI32(_iter83.size());
              for (java.lang.String _iter84 : _iter83)
              {
      ...
      if (struct.isSetTaken_by()) {
        {
          ...
          for (java.lang.String _iter86 : struct.taken_by)
          {
      ...
      if (struct.isSetJustifications()) {
        {
          ...
          for (java.util.List<java.lang.String> _iter87 : struct.justifications)
          {
            {
              oprot.writeI32(_iter87.size());
              for (java.lang.String _iter88 : _iter87)
              {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.attr_names = new java.util.ArrayList<java.lang.String>(_list89.size);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.attr_values = new java.util.ArrayList<java.util.List<java.lang.String>>(_list92.size);
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.scores = new java.util.ArrayList<java.lang.Double>(_list98.size);
          double _elem99;
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.taken_by = new java.util.ArrayList<java.lang.String>(_list101.size);
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.justifications = new java.util.ArrayList<java.util.List<java.lang.String>>(_list104.size);
