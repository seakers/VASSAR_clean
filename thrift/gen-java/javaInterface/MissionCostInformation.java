    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MissionCostInformation struct) throws org.apache.thrift.TException {
      ...
      if (struct.mass_budget != null) {
        oprot.writeFieldBegin(MASS_BUDGET_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter32 : struct.mass_budget.entrySet())
          {
      ...
      if (struct.power_budget != null) {
        oprot.writeFieldBegin(POWER_BUDGET_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter33 : struct.power_budget.entrySet())
          {
      ...
      if (struct.isSetMass_budget()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter34 : struct.mass_budget.entrySet())
          {
      ...
      if (struct.isSetPower_budget()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter35 : struct.power_budget.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.mass_budget = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map36.size);
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.power_budget = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map40.size);
