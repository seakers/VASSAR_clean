...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.11.0)", date = "2018-03-29")
    ...
    private static class getCritique_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<getCritique_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.inputs = new java.util.ArrayList<java.lang.Boolean>(_list64.size);
                  boolean _elem65;
                  for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                  {
                    _elem65 = iprot.readBool();
                    struct.inputs.add(_elem65);
                  }
                  iprot.readListEnd();
                }
                struct.setInputsIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getCritique_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.inputs != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.BOOL, struct.inputs.size()));
            for (boolean _iter67 : struct.inputs)
            {
    ...
    private static class getCritique_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<getCritique_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getCritique_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetInputs()) {
          {
            oprot.writeI32(struct.inputs.size());
            for (boolean _iter68 : struct.inputs)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.inputs = new java.util.ArrayList<java.lang.Boolean>(_list69.size);
            boolean _elem70;
            for (int _i71 = 0; _i71 < _list69.size; ++_i71)
            {
              _elem70 = iprot.readBool();
              struct.inputs.add(_elem70);
            }
          }
          struct.setInputsIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.arch = new java.util.ArrayList<java.lang.Boolean>(_list80.size);
                  boolean _elem81;
                  for (int _i82 = 0; _i82 < _list80.size; ++_i82)
                  {
                    _elem81 = iprot.readBool();
                    struct.arch.add(_elem81);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getScoreExplanation_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.arch != null) {
          oprot.writeFieldBegin(ARCH_FIELD_DESC);
          {
            ...
            for (boolean _iter83 : struct.arch)
            {
        ...
        if (struct.isSetArch()) {
          {
            ...
            for (boolean _iter84 : struct.arch)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.arch = new java.util.ArrayList<java.lang.Boolean>(_list85.size);
            boolean _elem86;
            for (int _i87 = 0; _i87 < _list85.size; ++_i87)
            {
              _elem86 = iprot.readBool();
              struct.arch.add(_elem86);
            }
          }
          struct.setArchIsSet(true);
        }
    ...
    private static class getScoreExplanation_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getScoreExplanation_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<ObjectiveSatisfaction>(_list88.size);
                  ObjectiveSatisfaction _elem89;
                  for (int _i90 = 0; _i90 < _list88.size; ++_i90)
                  {
                    _elem89 = new ObjectiveSatisfaction();
                    _elem89.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getScoreExplanation_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (ObjectiveSatisfaction _iter91 : struct.success)
            {
              _iter91.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getScoreExplanation_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getScoreExplanation_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getScoreExplanation_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (ObjectiveSatisfaction _iter92 : struct.success)
            {
              _iter92.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<ObjectiveSatisfaction>(_list93.size);
            ObjectiveSatisfaction _elem94;
            for (int _i95 = 0; _i95 < _list93.size; ++_i95)
            {
              _elem94 = new ObjectiveSatisfaction();
              _elem94.read(iprot);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.params_map = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map96.size);
                  ...
                  for (int _i99 = 0; _i99 < _map96.size; ++_i99)
                  {
                    ...
                    struct.params_map.put(_key97, _val98);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, changeLoadedFiles_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.params_map != null) {
          oprot.writeFieldBegin(PARAMS_MAP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter100 : struct.params_map.entrySet())
            {
        ...
        if (struct.isSetParams_map()) {
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter101 : struct.params_map.entrySet())
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.params_map = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map102.size);
            ...
            for (int _i105 = 0; _i105 < _map102.size; ++_i105)
            {
              ...
              struct.params_map.put(_key103, _val104);
            }
          }
          struct.setParams_mapIsSet(true);
        }
