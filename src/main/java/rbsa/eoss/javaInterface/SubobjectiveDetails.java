            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attr_names = new java.util.ArrayList<String>(_list62.size);
                String _elem63;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attr_values = new java.util.ArrayList<java.util.List<String>>(_list65.size);
                java.util.List<String> _elem66;
                for (int _i67 = 0; _i67 < _list65.size; ++_i67)
                {
                  {
                    org.apache.thrift.protocol.TList _list68 = iprot.readListBegin();
                    _elem66 = new java.util.ArrayList<String>(_list68.size);
                    String _elem69;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.scores = new java.util.ArrayList<Double>(_list71.size);
                double _elem72;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.taken_by = new java.util.ArrayList<String>(_list74.size);
                String _elem75;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.justifications = new java.util.ArrayList<java.util.List<String>>(_list77.size);
                java.util.List<String> _elem78;
                for (int _i79 = 0; _i79 < _list77.size; ++_i79)
                {
                  {
                    org.apache.thrift.protocol.TList _list80 = iprot.readListBegin();
                    _elem78 = new java.util.ArrayList<String>(_list80.size);
                    String _elem81;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SubobjectiveDetails struct) throws org.apache.thrift.TException {
      ...
      if (struct.attr_names != null) {
        oprot.writeFieldBegin(ATTR_NAMES_FIELD_DESC);
        {
          ...
          for (String _iter83 : struct.attr_names)
          {
      ...
      if (struct.attr_values != null) {
        oprot.writeFieldBegin(ATTR_VALUES_FIELD_DESC);
        {
          ...
          for (java.util.List<String> _iter84 : struct.attr_values)
          {
            {
      ...
      if (struct.taken_by != null) {
        oprot.writeFieldBegin(TAKEN_BY_FIELD_DESC);
        {
          ...
          for (String _iter87 : struct.taken_by)
          {
      ...
      if (struct.justifications != null) {
        oprot.writeFieldBegin(JUSTIFICATIONS_FIELD_DESC);
        {
          ...
          for (java.util.List<String> _iter88 : struct.justifications)
          {
            {
      ...
      if (struct.isSetAttr_names()) {
        {
          ...
          for (String _iter90 : struct.attr_names)
          {
      ...
      if (struct.isSetAttr_values()) {
        {
          ...
          for (java.util.List<String> _iter91 : struct.attr_values)
          {
            {
              oprot.writeI32(_iter91.size());
              for (String _iter92 : _iter91)
              {
      ...
      if (struct.isSetTaken_by()) {
        {
          ...
          for (String _iter94 : struct.taken_by)
          {
      ...
      if (struct.isSetJustifications()) {
        {
          ...
          for (java.util.List<String> _iter95 : struct.justifications)
          {
            {
              oprot.writeI32(_iter95.size());
              for (String _iter96 : _iter95)
              {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.attr_names = new java.util.ArrayList<String>(_list97.size);
          String _elem98;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.attr_values = new java.util.ArrayList<java.util.List<String>>(_list100.size);
          java.util.List<String> _elem101;
          ...
          {
            {
              ...
              _elem101 = new java.util.ArrayList<String>(_list103.size);
              String _elem104;
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.scores = new java.util.ArrayList<Double>(_list106.size);
          double _elem107;
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.taken_by = new java.util.ArrayList<String>(_list109.size);
          String _elem110;
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.justifications = new java.util.ArrayList<java.util.List<String>>(_list112.size);
          java.util.List<String> _elem113;
          ...
          {
            {
              ...
              _elem113 = new java.util.ArrayList<String>(_list115.size);
              String _elem116;
