            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.payload = new java.util.ArrayList<String>(_list24.size);
                String _elem25;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.mass_budget = new java.util.HashMap<String,Double>(2*_map27.size);
                String _key28;
                double _val29;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.power_budget = new java.util.HashMap<String,Double>(2*_map31.size);
                String _key32;
                double _val33;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.cost_budget = new java.util.HashMap<String,Double>(2*_map35.size);
                String _key36;
                double _val37;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MissionCostInformation struct) throws org.apache.thrift.TException {
      ...
      if (struct.payload != null) {
        oprot.writeFieldBegin(PAYLOAD_FIELD_DESC);
        {
          ...
          for (String _iter39 : struct.payload)
          {
      ...
      if (struct.mass_budget != null) {
        oprot.writeFieldBegin(MASS_BUDGET_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<String, Double> _iter40 : struct.mass_budget.entrySet())
          {
      ...
      if (struct.power_budget != null) {
        oprot.writeFieldBegin(POWER_BUDGET_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<String, Double> _iter41 : struct.power_budget.entrySet())
          {
      ...
      if (struct.cost_budget != null) {
        oprot.writeFieldBegin(COST_BUDGET_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<String, Double> _iter42 : struct.cost_budget.entrySet())
          {
      ...
      if (struct.isSetPayload()) {
        {
          ...
          for (String _iter43 : struct.payload)
          {
      ...
      if (struct.isSetMass_budget()) {
        {
          ...
          for (java.util.Map.Entry<String, Double> _iter44 : struct.mass_budget.entrySet())
          {
      ...
      if (struct.isSetPower_budget()) {
        {
          ...
          for (java.util.Map.Entry<String, Double> _iter45 : struct.power_budget.entrySet())
          {
      ...
      if (struct.isSetCost_budget()) {
        {
          ...
          for (java.util.Map.Entry<String, Double> _iter46 : struct.cost_budget.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.payload = new java.util.ArrayList<String>(_list47.size);
          String _elem48;
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.mass_budget = new java.util.HashMap<String,Double>(2*_map50.size);
          String _key51;
          double _val52;
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.power_budget = new java.util.HashMap<String,Double>(2*_map54.size);
          String _key55;
          double _val56;
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.cost_budget = new java.util.HashMap<String,Double>(2*_map58.size);
          String _key59;
          double _val60;
